        ...
        <div class="col">
            ...
            <div class="row">
                <div class="card shadow border-0 w-100">
                    <div class="card-body">
                        <form action="{{ route('dashboard.course.new.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="title"
                                           ...
                                           placeholder="Insert your course title" required value="{{ old('title') }}">
                                    @error('title')
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select id="difficulty"
                                        ...
                                        <option {{ old('difficulty') ? '' : 'selected' }}>Select Difficulty</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select id="tag"
                                        ...
                                        @foreach($tags as $tag)
                                            <option value="{{ $tag->id }}" {{ old('category') == $tag->id ? 'selected' : '' }}>{{ $tag->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                    <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="form-row">
                                <div class="col mt-3">
                                    <button type="submit" name="save-course" class="btn btn-primary pull-right shadow">Save and Next
                                    </button>
                                </div>
                            </div>
                        </form>
